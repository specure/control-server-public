...
@Service
@Profile("beta")
public class ApplicationVersionMapperBetaImpl implements ApplicationVersionMapper {
    ...
    public ApplicationVersionResponse applicationVersionFileToApplicationVersionResponse(ApplicationVersionFile applicationVersionFile) {
        return applicationVersionBlockToApplicationVersionResponse(applicationVersionFile.getBeta());
    }
}
